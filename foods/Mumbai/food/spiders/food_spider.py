...
class food(scrapy.Spider):
    name = "food"
    start_urls = ['https://www.foodpanda.in/restaurants/city/mumbai?currentUrl=https%3A%2F%2Fwww.foodpanda.in%2Frestaurants%2Fcity%2Fmumbai&user_search=&sort=&sort=&page=1']
    ...
    def parse(self, response):
        ...
        next_page='https://www.foodpanda.in/restaurants/city/mumbai?currentUrl=https%3A%2F%2Fwww.foodpanda.in%2Frestaurants%2Fcity%2Fmumbai&user_search=&sort=&sort=&page={num}'
        if num < 80:
            num=num+1
